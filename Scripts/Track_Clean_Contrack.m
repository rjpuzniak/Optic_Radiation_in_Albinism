...
for i=1:length(rois_sets)
    ...
    if tracking_required
        ...
        batchFileName = ctrInitBatchScore(infoFile, 2500, 0)
    ...
    for j = 1:length(subjects)
        ...
        for k = 1:length(v1_rois)
            ...
            output_folder = strcat(analysis_folder, '/Tracking_results/Contrack_',roi_set,'/',subject)
            mkdir(output_folder)
            ...
            mkdir(strcat(analysis_folder,'/Tracking_results/Contrack_',roi_set,'_mrtrix/',subject))
            dtiExportFibersMrtrix(or_cleaned_selected, strcat(analysis_folder,'/Tracking_results/Contrack_',roi_set,'_mrtrix/',subject,'/',subject,'_',fiber_labels{k},'.tck'));
        end
    end    
end